...
%  \begin{figure}
%   \centering
%   \only<1>{\includegraphics[width=0.5\textwidth]{images/nyquist1.jpg}}%
%   \only<2>{\includegraphics[width=0.5\textwidth]{images/nyquist2.png}}
%  \end{figure}
...
\begin{frame}{Overall strategy}
 ...
 \end{itemize}
 \centering
 \only<1>{\includegraphics[width=0.9\textwidth]{images/trainingsplit-pre.pdf}}%
 \only<2>{\includegraphics[width=0.9\textwidth]{images/trainingsplit-notest.pdf}}%
 \only<3->{\includegraphics[width=0.9\textwidth]{images/trainingsplit.pdf}}%
...
\begin{frame}{How to learn?}
 \begin{columns}
  \begin{column}{0.5\textwidth}
  \centering
   \includegraphics[width=0.85\textwidth]{images/deeplearningprocess.png}
  \end{column}
...
\begin{frame}{Biological motivation}
 ...
 \begin{center}
  ...
  \includegraphics[width=0.4\textwidth]{images/neuron_model.jpeg}
...
\begin{frame}{Feed Forward Networks}
 \begin{itemize}
  ...
  \begin{center}
   \includegraphics[width=0.6\textwidth]{images/feedforward.png}
  \end{center}
...
% Many possible. Simple non-linear scala functions.\vspace{4mm}
  ...
  \begin{column}{0.3\textwidth}
   \includegraphics[width=\textwidth]{images/sigmoid-crop.pdf}
  \end{column}
 \end{columns}
 ...
 \begin{columns}
  ...
  \end{column}
  \begin{column}{0.3\textwidth}
   \includegraphics[width=\textwidth]{images/hyperbolictangent-crop.pdf}
  \end{column}
 \end{columns}
\end{frame}
...
\begin{frame}{Activation functions}
  ...
  \end{column}
  \begin{column}{0.3\textwidth}
   \includegraphics[width=\textwidth]{images/relu-crop.pdf}
  \end{column}
 \end{columns}
 ...
 \begin{columns}
  ...
  \end{column}
  \begin{column}{0.3\textwidth}
   \includegraphics[width=\textwidth]{images/leakyrelu-crop.pdf}
  \end{column}
 \end{columns}
\end{frame}
...
\begin{frame}{Training feedforward neural networks (II)}
 \begin{center}
  \includegraphics[width=0.3\textwidth]{images/deeplearningprocess.png}\hspace{3mm}
  \includegraphics[width=0.6\textwidth]{images/feedforward.png}
 \end{center}
  \begin{enumerate}
...
\begin{frame}{Motivation}
 \begin{center}
  \includegraphics[width=0.5\textwidth]{images/deepfeedforward.png}
 \end{center}
Is this input representation suitable for images?
\begin{center}
 \includegraphics[height=2cm]{images/airplane1.jpg}
 \includegraphics[height=2cm]{images/dog.jpg}
 \includegraphics[height=2cm]{images/table.jpg}
 \includegraphics[height=2cm]{images/cat.jpg}
\end{center}
...
\end{itemize}
\begin{center}
 \includegraphics[width=0.9\textwidth]{images/aCNN.png}
\end{center}
...
\begin{center}
 \includegraphics[width=0.8\textwidth]{images/2d_convolution_pa3.png}
\end{center}
\begin{itemize}
...
\begin{center}
 \includegraphics[width=0.7\textwidth]{images/cnn1.png}
\end{center}
\begin{flushright}
...
What is the width and height of the output image?
 \begin{center}
 \includegraphics[width=0.7\textwidth]{images/cnn2.png}
\end{center}
\begin{flushright}
 {\footnotesize Slide from: Fei-Fei Li \& Andrej Karpathy \& Justin Johnson}
\end{flushright}
...
\begin{frame}{Convolutions in ConvNets (III)}
 \begin{center}
 \includegraphics[width=0.7\textwidth]{images/cnn3.png}
\end{center}
\begin{flushright}
 {\footnotesize Slide from: Fei-Fei Li \& Andrej Karpathy \& Justin Johnson}
\end{flushright}
...
\begin{frame}{Convolutions in ConvNets (IV)}
 \begin{center}
 \includegraphics[width=0.7\textwidth]{images/cnn4.png}
\end{center}
\begin{flushright}
 {\footnotesize Slide from: Fei-Fei Li \& Andrej Karpathy \& Justin Johnson}
\end{flushright}
...
\begin{frame}{Convolutions in ConvNets (V)}
 \begin{center}
 \includegraphics[width=0.7\textwidth]{images/cnn5.png}
\end{center}
\begin{flushright}
 {\footnotesize Slide from: Fei-Fei Li \& Andrej Karpathy \& Justin Johnson}
\end{flushright}
...
The filters \textbf{must} have the same depth as the input. The output depth corresponds to the number of filters.
 \begin{center}
 \includegraphics[width=0.4\textwidth]{images/cnn6.png}
\end{center}
\begin{flushright}
 {\footnotesize Slide from: Fei-Fei Li \& Andrej Karpathy \& Justin Johnson}
\end{flushright}
...
We can repeat the operation with a second convolutional layer.
 \begin{center}
 \includegraphics[width=0.8\textwidth]{images/cnn-end.png}
\end{center}
\begin{flushright}
 {\footnotesize Slide from: Fei-Fei Li \& Andrej Karpathy \& Justin Johnson}
\end{flushright}
...
\begin{frame}{Receptive field}
 ...
 \end{itemize}
   \begin{center}
 \includegraphics[width=0.4\textwidth]{images/receptivefield.png}
\end{center}
\end{frame}
...
\begin{center}
 \includegraphics[width=0.9\textwidth]{images/smallcnn.png}
\end{center}
\end{itemize}
\end{frame}
...
\begin{frame}{Drop-out regularisation}
 ...
 \end{itemize}
\begin{center}
 \includegraphics[width=0.9\textwidth]{images/dropout.png}
\end{center}
\end{frame}
...
\begin{frame}{AlexNet CNN (2012)}
 ...
 \end{itemize}
\begin{center}
 \includegraphics[width=0.7\textwidth]{images/alexnet.png}
\end{center}
\end{frame}
...
\begin{frame}{VGG CNN (2015)}
 ...
 \end{itemize}
\begin{center}
 \includegraphics[width=0.7\textwidth]{images/vgg.png}
\end{center}
\end{frame}
...
\begin{columns}
 \begin{column}{0.2\textwidth}
  \includegraphics[width=\textwidth]{images/resnet.png}
 \end{column}
 ...
 \end{itemize}
\begin{center}
 \includegraphics[width=0.5\textwidth]{images/residualmodule.png}
\end{center}
 \end{column}
\end{columns}
\end{frame}
...
\begin{frame}{U-Net (2015)}
 ...
 \end{itemize}
\begin{center}
 \includegraphics[width=0.5\textwidth]{images/u-net.png}
\end{center}
\end{frame}
...
\end{itemize}
\begin{center}
 \includegraphics[width=0.55\textwidth]{images/3dconvolutions.png}
\end{center}
\end{frame}
...
\begin{frame}{Finetunning (pre-trained CNNs)}
  \centering
  \includegraphics[width=0.8\textwidth]{images/finetuning.png}
  \begin{flushright}
...
\begin{columns}
 \begin{column}{0.6\textwidth}
    \centerimage{1}{images/early-stopping.jpg}
 \end{column}
 \begin{column}{0.4\textwidth}
...
\end{itemize}
 ...
 \includegraphics[height=3.6cm]{images/distillation-1.jpeg}\hspace{3mm}%
 \includegraphics[height=3.6cm]{images/distillation-2.png}
\end{frame}
...
\begin{frame}{RNN unfolding}
 \centerimage{0.7}{images/rnn-unwrap.png}\vspace{-5mm}
