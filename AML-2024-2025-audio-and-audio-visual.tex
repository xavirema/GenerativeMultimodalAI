...
\centerimage{0.5}{figs/AV/AVLocalisation-3.png}
\end{frame}

\begin{frame}{Learn to separate sounds {\small [Gao et al, ECCV 2018]}}
 \centerimage{1}{figs/AV/LearnToSeparateTeaser.png}
...
\begin{frame}{Learn to separate sounds (II) {\small [Gao et al, ECCV 2018]}}
 \centerimage{1}{figs/AV/LearnToSeparateArch.png}
  \begin{itemize}
...
\begin{frame}{Non-negative matrix factorisation?}
 \centerimage{0.7}{figs/AV/nmf_en.png}
...
\begin{frame}{Learn to separate sounds (III) {\small [Gao et al, ECCV 2018]}}
 ...
 \centerimage{1}{figs/AV/VisionToNMFSelection.png}
\end{frame}
%
% \begin{frame}{What if we have two microphones? {\small [Gao et al, ICCV 2019]}}
%   \centerimage{0.6}{figs/AV/25DSoundTeaser.png}
...
%   \begin{columns}
%    \begin{column}{0.5\textwidth}
%        \centerimage{1}{figs/AV/25DSoundRecordingSetup.png}
%    \end{column}
%    \begin{column}{0.5\textwidth}
%         We need data!!!
%
...
%   \centerimage{0.8}{figs/AV/25DSoundArchitecture.png}
...
% %   \begin{columns}
% %    \begin{column}{0.5\textwidth}
%        \centerimage{0.7}{figs/AV/25DSound-MixSeparate.png}
% %    \end{column}
% %    \begin{column}{0.5\textwidth}
...
\begin{frame}{Can we separate voice? (back to single microphone) {\small [Gao et al, CVPR 2021]}}
 ...
 \centerimage{0.6}{figs/AV/VisualVoiceTeaser.png}
\end{frame}

\begin{frame}{Can we do that with voice? (II) {\small [Gao et al, CVPR 2021]}}
 \centerimage{0.6}{figs/AV/VisualVoiceArchitecture.png}
...
\begin{frame}{Can we do that with voice? (III) {\small [Gao et al, CVPR 2021]}}
 \centerimage{0.9}{figs/AV/VisualVoiceFulllArch.png}
%  Similar U-Net architecture, but:
%  \begin{itemize}
%   \item We need to fuse face and lip features.
%   \item Lip information changes over time.
...
%       \centerimage{1}{figs/AV/AVLocalisation-1.png}
%    \end{column}
%    \begin{column}{0.3\textwidth}
%       \centerimage{1}{figs/AV/AVLocalisation-2.png}
%    \end{column}
%    \begin{column}{0.3\textwidth}
%       \centerimage{1}{figs/AV/AVLocalisation-4.png}
%    \end{column}
%  \end{columns}\vspace{3mm}
%
%
...
\begin{columns}
 \begin{column}{0.5\textwidth}
  \resizebox{\textwidth}{!}{\input{tikz/v_vae.tex}}
...
\begin{columns}
 ...
 \centering
%  Encoder-Decoder
   \resizebox{\textwidth}{!}{\input{tikz/av_vae.tex}}\vspace{2mm}
...
\begin{figure}
\centering
\only<1>{\includegraphics[width=0.8\textwidth]{images/spectrogram_cut.png}}%
\only<2->{\includegraphics[width=0.8\textwidth]{images/spectrogram.png}}
\end{figure}
\vspace{-3mm}
\begin{equation*}
...
\begin{frame}{AV Conditional VAE for Speech Enhancement}
\begin{figure}
\centering\includegraphics[width=0.8\textwidth]{images/spectrogram.png}
\end{figure}
\vspace{-3mm}
\begin{equation*}
...
\begin{frame}{VAE Mixture Model\footnote{Sadeghi, M., \textit{et. al.}, (2021), IEEE ICASSP.}}
 ...
 \centering
  \begin{column}{0.6\textwidth}
    \resizebox{\textwidth}{!}{\input{tikz/vae_mm.tex}}
  \end{column}
  \begin{column}{0.4\textwidth}
